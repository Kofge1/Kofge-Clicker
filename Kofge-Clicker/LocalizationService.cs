...
internal static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Mouse.TestInstruction"] = "Place the cursor here and activate the clicker with its hotkey.",
        ...
        ["Tooltips.MouseTest"] = "Counts clicks received in this area and measures their live CPS. It does not change your settings.",
    ...
    private static readonly Dictionary<string, string> Russian = new(English, StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Mouse.TestInstruction"] = "Наведите курсор сюда и активируйте кликер назначенным хоткеем.",
        ...
        ["Tooltips.MouseTest"] = "Считает клики в этой области и измеряет их текущий CPS. Настройки кликера не изменяются.",
