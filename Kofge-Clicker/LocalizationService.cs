...
internal static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Macros.Title"] = "Action Recorder",
        ["Macros.Current"] = "Recording",
        ["Macros.Create"] = "New",
        ...
        ["Macros.JournalFilter"] = "Filter",
        ["Macros.JournalFilterAll"] = "All actions",
        ["Macros.JournalFilterKeyboard"] = "Keyboard",
        ["Macros.JournalFilterMouseButtons"] = "Mouse buttons",
        ["Macros.JournalFilterMovement"] = "Mouse movement",
        ["Macros.JournalFilterWheel"] = "Mouse wheel",
        ["Macros.JournalUndo"] = "Undo",
        ["Macros.JournalRedo"] = "Redo",
        ["Macros.SleepColumnNumber"] = "#",
        ["Macros.SleepColumnTime"] = "Time",
        ["Macros.SleepColumnDelay"] = "Sleep, ms",
        ["Macros.SleepColumnAction"] = "Action",
        ["Macros.SleepBeforeEvent"] = "Sleep before selected",
        ["Macros.JournalSleepLabel"] = "Sleep, ms",
        ["Macros.SleepMixedValues"] = "Mixed values",
        ["Macros.SleepApply"] = "Apply Sleep",
        ["Macros.JournalCoordinates"] = "Coordinates",
        ["Macros.JournalApplyCoordinates"] = "Apply coordinates",
        ["Macros.CoordinateMixedValues"] = "Mixed",
        ["Macros.CoordinateInvalid"] = "Enter a whole number for coordinate {0}.",
        ["Macros.SleepSave"] = "Save changes",
        ["Macros.SleepInvalid"] = "Enter a value from 0 to {0} ms.",
        ["Macros.SleepTooLong"] = "The edited recording would be too long.",
        ["Macros.JournalDelete"] = "Delete selected",
        ["Macros.JournalEditHint"] = "Sleep applies to every selected action. Deleting also removes its preceding pause.",
        ["Macros.JournalEditorHint"] = "Sleep: all selected. X/Y: selected mouse actions.",
        ["Macros.JournalReset"] = "Reset edits",
        ["Macros.JournalSummary"] = "Selected: {0}  •  Actions: {1}  •  {2}",
        ["Macros.JournalFilteredSummary"] = "Selected: {0}  •  Shown: {1}/{2}  •  {3}",
        ["Macros.JournalChanges"] = "Sleep changed: {0}  •  Deleted: {1}",
        ["Macros.JournalDetailedChanges"] = "Sleep: {0}  •  Coordinates: {1}  •  Deleted: {2}",
        ["Macros.JournalNoChanges"] = "No unsaved changes",
        ["Macros.JournalPairWarning"] = "{0}  •  Unpaired inputs: {1}",
        ["Macros.JournalInvalidRecording"] = "This recording contains invalid event timing.",
        ["Macros.JournalSaved"] = "Macro journal saved",
        ["Macros.DefaultName"] = "Macro {0}",
        ["Macros.CreateTitle"] = "New recording",
        ["Macros.CreatePrompt"] = "Enter a name for this recording.",
        ["Macros.RenameTitle"] = "Rename recording",
        ["Macros.RenamePrompt"] = "Enter a new name for this recording.",
        ["Macros.Renamed"] = "Recording renamed",
        ["Macros.Duplicated"] = "Recording duplicated",
        ["Macros.DeleteTitle"] = "Delete recording",
        ["Macros.DeleteQuestion"] = "Delete \"{0}\"? This action cannot be undone.",
        ["Macros.Deleted"] = "Recording deleted",
        ["Macros.DeleteFailed"] = "The recording could not be deleted.",
        ["Macros.CopyName"] = "{0} copy",
        ["Macros.EmptyName"] = "The recording name cannot be empty.",
        ["Macros.AlreadyExists"] = "A recording with this name already exists.",
        ["Macros.SaveFailed"] = "The recording could not be saved.",
        ["Macros.NoMacros"] = "No recordings yet",
        ["Macros.Ready"] = "Ready to record",
        ["Macros.Recorded"] = "Recording saved",
        ["Macros.StartsIn"] = "Recording in {0}...",
        ["Macros.Recording"] = "Recording in progress",
        ["Macros.Saving"] = "Saving recording...",
        ["Macros.PlaybackStartsIn"] = "Playback in {0}...",
        ["Macros.Playing"] = "Playback in progress",
        ["Macros.Stats"] = "{0}  •  {1} actions",
        ["Macros.PlaybackProgress"] = "{0}  •  {1} / {2}",
        ["Macros.Repeats"] = "Repeats",
        ["Macros.Loop"] = "Loop",
        ["Macros.RepeatDelay"] = "Pause",
        ["Macros.MillisecondsShort"] = "ms",
        ["Macros.StartDelay"] = "Start delay",
        ["Macros.SecondsShort"] = "sec",
        ["Macros.PlayingRepeat"] = "Playing repeat {0} of {1}",
        ["Macros.PlayingLoop"] = "Playing loop {0}",
        ["Macros.SettingsHint"] = "{0}: safe stop",
        ["Macros.LatestActions"] = "Latest actions",
        ["Macros.PlaybackActions"] = "Played actions",
        ["Macros.EmptyPreview"] = "Recorded actions will appear here.",
        ["Macros.WaitingForFirstAction"] = "Waiting for the first action...",
        ["Macros.Hint"] = "Record and replay mouse movement, all mouse buttons, wheel scrolling, keyboard input and key combinations. Use the configured stop hotkey to end an active session.",
        ["Macros.RecordingHint"] = "Move the mouse and use the keyboard normally. Press {0} when you want to stop and save the recording.",
        ["Macros.PlaybackHint"] = "The original action timing is preserved. Press {0} at any time to stop safely.",
        ["Macros.RecordingStarted"] = "Recording started. Stop with:",
        ["Macros.RecordingCountdown"] = "Recording starts in {0} sec.",
        ["Macros.RecordingSaved"] = "Recording saved",
        ["Macros.PlaybackCountdown"] = "Playback starts in {0} sec.",
        ["Macros.PlaybackStarted"] = "Playback started. Stop with:",
        ["Macros.PlaybackCompleted"] = "Playback completed:",
        ["Macros.PlaybackStopped"] = "Playback stopped",
        ["Macros.NothingToPlay"] = "Record at least one action before starting playback.",
        ["Macros.PlaybackFailed"] = "Playback stopped because an input event could not be sent.",
        ["Macros.Pressed"] = "pressed",
        ["Macros.Released"] = "released",
        ["Macros.EventKey"] = "Key {0} {1}",
        ["Macros.EventMouseButton"] = "Mouse {0} {1}",
        ["Macros.EventMove"] = "Pointer moved to {0}, {1}",
        ["Macros.EventWheel"] = "Mouse wheel {0}",
        ["Macros.EventHorizontalWheel"] = "Horizontal wheel {0}",
        ...
        ["Hotkeys.ServiceGroup"] = "Application",
        ["Hotkeys.MacroGroup"] = "Action Recorder",
        ...
        ["Hotkeys.MacroRecord"] = "Start recording",
        ["Hotkeys.MacroPlay"] = "Play recording",
        ["Hotkeys.MacroStop"] = "Stop recording",
        ...
        ["Tooltips.TabMacros"] = "Record keyboard and mouse actions into a separate macro file.",
        ...
        ["Tooltips.MacroStop"] = "Stops an active recording or playback. The configured stop hotkey works globally.",
        ["Tooltips.MacroPreview"] = "Shows the latest recorded or played keyboard and mouse actions.",
        ["Tooltips.MacroJournal"] = "Opens the selected recording's complete action journal.",
        ["Tooltips.MacroRename"] = "Changes the name of the selected recording.",
        ["Tooltips.MacroDuplicate"] = "Creates an independent copy of the selected recording and its playback settings.",
        ["Tooltips.MacroDelete"] = "Permanently deletes the selected recording after confirmation.",
        ["Tooltips.MacroRepeats"] = "Sets how many times the selected recording will be played, from 1 to 999.",
        ["Tooltips.MacroLoop"] = "Repeats the selected recording continuously until you use the configured stop hotkey.",
        ["Tooltips.MacroRepeatDelay"] = "Sets the pause between repeats from 0 to 600000 milliseconds.",
        ["Tooltips.MacroStartDelay"] = "Waits 0 to 10 seconds before the first playback. Zero starts immediately.",
        ["Tooltips.JournalFilter"] = "Show only the selected type of action. Filtering does not delete events.",
        ["Tooltips.JournalTimeline"] = "All recorded actions in time order. Use Ctrl/Shift to select multiple rows, Ctrl+A to select all, or Ctrl+C/Ctrl+V to copy and paste rows.",
        ["Tooltips.JournalScrollbar"] = "Scroll through recorded actions. You can also use the mouse wheel over the journal.",
        ["Tooltips.JournalUndo"] = "Undo the most recent unsaved journal change.",
        ["Tooltips.JournalRedo"] = "Redo a journal change that was undone.",
        ["Tooltips.JournalSleep"] = "Pause before each selected action, in milliseconds. Editing it shifts subsequent actions in time.",
        ["Tooltips.JournalApplySleep"] = "Apply the entered pause to every selected action.",
        ["Tooltips.JournalX"] = "Horizontal screen coordinate for selected mouse actions.",
        ["Tooltips.JournalY"] = "Vertical screen coordinate for selected mouse actions.",
        ["Tooltips.JournalApplyCoordinates"] = "Apply X and Y to the selected mouse actions. Keyboard events are not changed.",
        ["Tooltips.JournalDelete"] = "Delete the selected actions and their preceding pauses. Save to keep the changes.",
        ["Tooltips.JournalReset"] = "Discard all unsaved journal edits and restore the original recording.",
        ["Tooltips.JournalSave"] = "Save all journal edits to the selected recording.",
        ["Tooltips.JournalCancel"] = "Close the journal without saving unsaved edits.",
        ["Tooltips.ClickerHotkey"] = "The keyboard key or mouse button that starts and stops clicking.",
        ["Tooltips.BindHotkey"] = "Assigns a new keyboard key or mouse button. Right-click the binding or this button to leave the action unassigned.",
        ["Tooltips.ClearHotkey"] = "Leaves this action without a hotkey.",
        ...
        ["Tooltips.HotkeyMacroRecord"] = "Starts recording the selected macro after the countdown.",
        ["Tooltips.HotkeyMacroPlay"] = "Plays the selected macro with its configured delay and repeat settings.",
        ["Tooltips.HotkeyMacroStop"] = "Stops an active macro countdown, recording or playback.",
        ...
        ["Tour.MacrosTitle"] = "Record and replay your actions",
        ["Tour.MacrosText"] = "Macros save mouse movement, buttons, scrolling, keyboard input and key combinations as a separate recording.",
        ["Tour.MacroCreateText"] = "Create and name a separate recording.",
        ["Tour.MacroRecordText"] = "Start after a countdown and stop safely with the assigned global hotkey.",
        ["Tour.MacroPlaybackText"] = "Replay the original timing, repeats and start delay.",
        ["Tour.MacroJournalText"] = "Review actions and edit pauses or mouse coordinates.",
        ...
        ["WhatsNew.MacroRecordingTitle"] = "Keyboard and mouse recording",
        ["WhatsNew.MacroClickOnlyTitle"] = "Record clicks without cursor paths",
        ["WhatsNew.MacroClickOnlyText"] = "A new ON/OFF switch skips mouse movement while keeping the recorded positions of clicks and other actions.",
        ["WhatsNew.JournalTooltipsTitle"] = "Action journal tips",
        ["WhatsNew.JournalTooltipsText"] = "Journal controls now have hover tips, and the coordinate label is aligned with the pause field.",
        ["WhatsNew.MacroCountdownTitle"] = "Clearer macro countdowns",
        ["WhatsNew.MacroCountdownText"] = "Recording and playback countdowns now appear beside notifications, updating each second before the macro starts.",
        ["WhatsNew.MacroRapidActionsTitle"] = "Reliable rapid macro actions",
        ...
        ["WhatsNew.MacroPlaybackTitle"] = "Flexible playback",
        ["WhatsNew.MacroPlaybackText"] = "Configure repeats, looping, pauses and start delay, then control recording and playback with global hotkeys.",
        ["WhatsNew.MacroUsabilityTitle"] = "Simpler everyday use",
        ["WhatsNew.MacroUsabilityText"] = "Leave unused hotkeys empty and restore the app reliably from the taskbar or tray during macro sessions.",
        ["WhatsNew.ReleaseReliabilityTitle"] = "Release-ready reliability",
        ["WhatsNew.ReleaseReliabilityText"] = "Macros are validated and stopped precisely, updates require SHA-256, and mixed-DPI displays are handled correctly.",
    ...
    private static readonly Dictionary<string, string> Russian = new(English, StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Macros.Title"] = "Запись действий",
        ["Macros.Current"] = "Запись",
        ["Macros.Create"] = "Создать",
        ...
        ["Macros.JournalFilter"] = "Фильтр",
        ["Macros.JournalFilterAll"] = "Все действия",
        ["Macros.JournalFilterKeyboard"] = "Клавиатура",
        ["Macros.JournalFilterMouseButtons"] = "Кнопки мыши",
        ["Macros.JournalFilterMovement"] = "Движение мыши",
        ["Macros.JournalFilterWheel"] = "Прокрутка мыши",
        ["Macros.JournalUndo"] = "Отменить",
        ["Macros.JournalRedo"] = "Повторить",
        ["Macros.SleepColumnNumber"] = "№",
        ["Macros.SleepColumnTime"] = "Время",
        ["Macros.SleepColumnDelay"] = "Sleep, мс",
        ["Macros.SleepColumnAction"] = "Действие",
        ["Macros.SleepBeforeEvent"] = "Пауза перед выбранными",
        ["Macros.JournalSleepLabel"] = "Пауза, мс",
        ["Macros.SleepMixedValues"] = "Разные значения",
        ["Macros.SleepApply"] = "Применить паузу",
        ["Macros.JournalCoordinates"] = "Координаты",
        ["Macros.JournalApplyCoordinates"] = "Применить",
        ["Macros.CoordinateMixedValues"] = "Разные",
        ["Macros.CoordinateInvalid"] = "Введите целое число для координаты {0}.",
        ["Macros.SleepSave"] = "Сохранить",
        ["Macros.SleepInvalid"] = "Введите значение от 0 до {0} мс.",
        ["Macros.SleepTooLong"] = "Макрос после изменения будет слишком длинным.",
        ["Macros.JournalDelete"] = "Удалить выбранные",
        ["Macros.JournalEditHint"] = "Пауза применяется ко всем выбранным действиям. При удалении убирается и пауза перед ним.",
        ["Macros.JournalEditorHint"] = "Пауза: все выбранные. X/Y: выбранные действия мыши.",
        ["Macros.JournalReset"] = "Сбросить правки",
        ["Macros.JournalSummary"] = "Выбрано: {0}  •  Действий: {1}  •  {2}",
        ["Macros.JournalFilteredSummary"] = "Выбрано: {0}  •  Показано: {1}/{2}  •  {3}",
        ["Macros.JournalChanges"] = "Sleep изменён: {0}  •  Удалено: {1}",
        ["Macros.JournalDetailedChanges"] = "Пауза: {0}  •  Координаты: {1}  •  Удалено: {2}",
        ["Macros.JournalNoChanges"] = "Несохранённых изменений нет",
        ["Macros.JournalPairWarning"] = "{0}  •  Без пары: {1}",
        ["Macros.JournalInvalidRecording"] = "Запись содержит некорректные отметки времени.",
        ["Macros.JournalSaved"] = "Журнал макроса сохранён",
        ["Macros.DefaultName"] = "Макрос {0}",
        ["Macros.CreateTitle"] = "Новая запись",
        ["Macros.CreatePrompt"] = "Введите название новой записи.",
        ["Macros.RenameTitle"] = "Переименование записи",
        ["Macros.RenamePrompt"] = "Введите новое название этой записи.",
        ["Macros.Renamed"] = "Запись переименована",
        ["Macros.Duplicated"] = "Создана копия записи",
        ["Macros.DeleteTitle"] = "Удаление записи",
        ["Macros.DeleteQuestion"] = "Удалить «{0}»? Это действие нельзя отменить.",
        ["Macros.Deleted"] = "Запись удалена",
        ["Macros.DeleteFailed"] = "Не удалось удалить запись.",
        ["Macros.CopyName"] = "{0} — копия",
        ["Macros.EmptyName"] = "Название записи не может быть пустым.",
        ["Macros.AlreadyExists"] = "Запись с таким названием уже существует.",
        ["Macros.SaveFailed"] = "Не удалось сохранить запись.",
        ["Macros.NoMacros"] = "Записей пока нет",
        ["Macros.Ready"] = "Готов к записи",
        ["Macros.Recorded"] = "Запись сохранена",
        ["Macros.StartsIn"] = "Запись через {0}...",
        ["Macros.Recording"] = "Идёт запись",
        ["Macros.Saving"] = "Сохранение записи...",
        ["Macros.PlaybackStartsIn"] = "Запуск через {0}...",
        ["Macros.Playing"] = "Идёт воспроизведение",
        ["Macros.Stats"] = "{0}  •  действий: {1}",
        ["Macros.PlaybackProgress"] = "{0}  •  {1} / {2}",
        ["Macros.Repeats"] = "Повторы",
        ["Macros.Loop"] = "Цикл",
        ["Macros.RepeatDelay"] = "Пауза",
        ["Macros.MillisecondsShort"] = "мс",
        ["Macros.StartDelay"] = "Перед запуском",
        ["Macros.SecondsShort"] = "сек.",
        ["Macros.PlayingRepeat"] = "Идёт повтор {0} из {1}",
        ["Macros.PlayingLoop"] = "Идёт цикл {0}",
        ["Macros.SettingsHint"] = "{0}: безопасная остановка",
        ["Macros.LatestActions"] = "Последние действия",
        ["Macros.PlaybackActions"] = "Выполненные действия",
        ["Macros.EmptyPreview"] = "Записанные действия появятся здесь.",
        ["Macros.WaitingForFirstAction"] = "Ожидание первого действия...",
        ["Macros.Hint"] = "Записывает и повторяет движение мыши, все её кнопки, прокрутку колеса, клавиатуру и сочетания клавиш. Для завершения используйте назначенную клавишу остановки.",
        ["Macros.RecordingHint"] = "Пользуйтесь мышью и клавиатурой как обычно. Нажмите {0}, чтобы остановить и сохранить запись.",
        ["Macros.PlaybackHint"] = "Исходные задержки между действиями сохраняются. Нажмите {0} в любой момент для безопасной остановки.",
        ["Macros.RecordingStarted"] = "Запись началась. Остановить:",
        ["Macros.RecordingCountdown"] = "Запись начнётся через {0} сек.",
        ["Macros.RecordingSaved"] = "Запись сохранена",
        ["Macros.PlaybackCountdown"] = "Воспроизведение через {0} сек.",
        ["Macros.PlaybackStarted"] = "Воспроизведение началось. Остановить:",
        ["Macros.PlaybackCompleted"] = "Воспроизведение завершено:",
        ["Macros.PlaybackStopped"] = "Воспроизведение остановлено",
        ["Macros.NothingToPlay"] = "Перед запуском запишите хотя бы одно действие.",
        ["Macros.PlaybackFailed"] = "Воспроизведение остановлено: не удалось отправить одно из действий.",
        ["Macros.Pressed"] = "нажата",
        ["Macros.Released"] = "отпущена",
        ["Macros.EventKey"] = "Клавиша {0} {1}",
        ["Macros.EventMouseButton"] = "Кнопка мыши {0} {1}",
        ["Macros.EventMove"] = "Курсор перемещён в {0}, {1}",
        ["Macros.EventWheel"] = "Колесо мыши {0}",
        ["Macros.EventHorizontalWheel"] = "Горизонтальная прокрутка {0}",
        ...
        ["Hotkeys.ServiceGroup"] = "Приложение",
        ["Hotkeys.MacroGroup"] = "Запись действий",
        ...
        ["Hotkeys.MacroRecord"] = "Начать запись",
        ["Hotkeys.MacroPlay"] = "Запустить запись",
        ["Hotkeys.MacroStop"] = "Остановить запись",
        ...
        ["Tooltips.TabMacros"] = "Запись действий клавиатуры и мыши в отдельный файл макроса.",
        ...
        ["Tooltips.MacroStop"] = "Останавливает активную запись или воспроизведение. Назначенная клавиша остановки работает глобально.",
        ["Tooltips.MacroPreview"] = "Показывает последние записанные или выполненные действия клавиатуры и мыши.",
        ["Tooltips.MacroJournal"] = "Открывает полный журнал действий выбранной записи.",
        ["Tooltips.MacroRename"] = "Изменяет название выбранной записи.",
        ["Tooltips.MacroDuplicate"] = "Создаёт независимую копию выбранной записи и её настроек воспроизведения.",
        ["Tooltips.MacroDelete"] = "Безвозвратно удаляет выбранную запись после подтверждения.",
        ["Tooltips.MacroRepeats"] = "Задаёт количество запусков выбранной записи от 1 до 999.",
        ["Tooltips.MacroLoop"] = "Повторяет выбранную запись до использования назначенной клавиши остановки.",
        ["Tooltips.MacroRepeatDelay"] = "Задаёт паузу между повторами от 0 до 600000 миллисекунд.",
        ["Tooltips.MacroStartDelay"] = "Ожидание от 0 до 10 секунд перед первым воспроизведением. При нуле запуск сразу.",
        ["Tooltips.JournalFilter"] = "Показывает только выбранный тип действий. Фильтр ничего не удаляет.",
        ["Tooltips.JournalTimeline"] = "Все действия по времени. Ctrl/Shift выделяет несколько строк, Ctrl+A — все, Ctrl+C/Ctrl+V — копирование и вставка.",
        ["Tooltips.JournalScrollbar"] = "Листает записанные действия. Колесо мыши также работает прямо над журналом.",
        ["Tooltips.JournalUndo"] = "Отменяет последнее несохранённое изменение журнала.",
        ["Tooltips.JournalRedo"] = "Повторяет отменённое изменение журнала.",
        ["Tooltips.JournalSleep"] = "Пауза перед каждым выбранным действием в миллисекундах. Её изменение сдвигает последующие действия по времени.",
        ["Tooltips.JournalApplySleep"] = "Применяет указанную паузу ко всем выделенным действиям.",
        ["Tooltips.JournalX"] = "Координата выбранных действий мыши по горизонтали.",
        ["Tooltips.JournalY"] = "Координата выбранных действий мыши по вертикали.",
        ["Tooltips.JournalApplyCoordinates"] = "Применяет X и Y к выбранным действиям мыши. События клавиатуры не меняются.",
        ["Tooltips.JournalDelete"] = "Удаляет выделенные действия и предшествующие им паузы. Для сохранения нажмите «Сохранить».",
        ["Tooltips.JournalReset"] = "Отменяет все несохранённые правки и восстанавливает исходную запись.",
        ["Tooltips.JournalSave"] = "Сохраняет все изменения журнала в выбранную запись.",
        ["Tooltips.JournalCancel"] = "Закрывает журнал без сохранения несохранённых правок.",
        ["Tooltips.ClickerHotkey"] = "Клавиша клавиатуры или кнопка мыши, которая запускает и останавливает клики.",
        ["Tooltips.BindHotkey"] = "Назначает новую клавишу или кнопку мыши. Нажмите правой кнопкой по привязке или этой кнопке, чтобы оставить действие без привязки.",
        ["Tooltips.ClearHotkey"] = "Оставляет это действие без горячей клавиши.",
        ...
        ["Tooltips.HotkeyMacroRecord"] = "Начинает запись выбранного макроса после обратного отсчёта.",
        ["Tooltips.HotkeyMacroPlay"] = "Запускает выбранный макрос с заданной задержкой и настройками повторов.",
        ["Tooltips.HotkeyMacroStop"] = "Останавливает отсчёт, запись или воспроизведение активного макроса.",
        ...
        ["Tour.MacrosTitle"] = "Запишите и повторите свои действия",
        ["Tour.MacrosText"] = "Макросы сохраняют движения и кнопки мыши, прокрутку, ввод с клавиатуры и сочетания клавиш в отдельную запись.",
        ["Tour.MacroCreateText"] = "Создайте отдельную запись и задайте ей название.",
        ["Tour.MacroRecordText"] = "Запустите запись после отсчёта и безопасно остановите назначенной глобальной клавишей.",
        ["Tour.MacroPlaybackText"] = "Повторите исходные задержки, количество повторов и паузу перед запуском.",
        ["Tour.MacroJournalText"] = "Просмотрите действия и измените паузы или координаты мыши.",
        ...
        ["WhatsNew.MacroRecordingTitle"] = "Запись клавиатуры и мыши",
        ["WhatsNew.MacroClickOnlyTitle"] = "Клики без траектории курсора",
        ["WhatsNew.MacroClickOnlyText"] = "Новый переключатель ON/OFF убирает движения мыши из записи, сохраняя координаты кликов и других действий.",
        ["WhatsNew.JournalTooltipsTitle"] = "Подсказки в журнале",
        ["WhatsNew.JournalTooltipsText"] = "В журнале появились всплывающие подсказки, а подпись координат выровнена с полем паузы.",
        ["WhatsNew.MacroCountdownTitle"] = "Наглядный отсчёт макросов",
        ["WhatsNew.MacroCountdownText"] = "Отсчёт перед записью и воспроизведением теперь показывается в углу уведомлений и обновляется каждую секунду.",
        ["WhatsNew.MacroRapidActionsTitle"] = "Надёжные быстрые действия",
        ...
        ["WhatsNew.MacroPlaybackTitle"] = "Гибкое воспроизведение",
        ["WhatsNew.MacroPlaybackText"] = "Настраивайте повторы, цикл, паузы и задержку запуска, используя глобальные горячие клавиши.",
        ["WhatsNew.MacroUsabilityTitle"] = "Удобнее в повседневной работе",
        ["WhatsNew.MacroUsabilityText"] = "Оставляйте ненужные хоткеи пустыми и надёжно возвращайте окно из панели задач или трея.",
        ["WhatsNew.ReleaseReliabilityTitle"] = "Стабильность к полноценному релизу",
        ["WhatsNew.ReleaseReliabilityText"] = "Макросы проверяются и точно останавливаются, обновления защищены SHA-256, улучшена работа с разным DPI.",
    ...
    private static readonly IReadOnlyDictionary<string, string> LegacyEnglishLabels =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Macros.SettingsHint"] = "F8: safe stop",
            ["Macros.Hint"] = "Record and replay mouse movement, all mouse buttons, wheel scrolling, keyboard input and key combinations. Press F8 to stop an active session.",
            ["Macros.RecordingHint"] = "Move the mouse and use the keyboard normally. Press F8 when you want to stop and save the recording.",
            ["Macros.PlaybackHint"] = "The original action timing is preserved. Press F8 at any time to stop safely.",
            ["Tooltips.MacroStop"] = "Stops an active recording or playback. You can also press F8.",
            ["Tooltips.MacroLoop"] = "Repeats the selected recording continuously until you press F8.",
            ["Tooltips.MacroPlay"] = "Replays the selected recording with its original timing and configured repeat settings after a three-second countdown.",
            ["Macros.PlaybackCountdown"] = "Playback starts in 3 seconds.",
            ["Macros.JournalUndo"] = "Undo  Ctrl+Z",
            ["Macros.JournalRedo"] = "Redo  Ctrl+Y",
    ...
    private static readonly IReadOnlyDictionary<string, string> LegacyRussianLabels =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Macros.SettingsHint"] = "F8: безопасная остановка",
            ["Macros.Hint"] = "Записывает и повторяет движение мыши, все её кнопки, прокрутку колеса, клавиатуру и сочетания клавиш. Нажмите F8 для остановки.",
            ["Macros.RecordingHint"] = "Пользуйтесь мышью и клавиатурой как обычно. Нажмите F8, чтобы остановить и сохранить запись.",
            ["Macros.PlaybackHint"] = "Исходные задержки между действиями сохраняются. Нажмите F8 в любой момент для безопасной остановки.",
            ["Tooltips.MacroStop"] = "Останавливает активную запись или воспроизведение. Также можно нажать F8.",
            ["Tooltips.MacroLoop"] = "Повторяет выбранную запись непрерывно до нажатия F8.",
            ["Tooltips.MacroPlay"] = "Запускает выбранную запись с исходными задержками и заданными повторами после трёхсекундного отсчёта.",
            ["Macros.PlaybackCountdown"] = "Воспроизведение начнётся через 3 секунды.",
            ["Macros.JournalUndo"] = "Отменить  Ctrl+Z",
            ["Macros.JournalRedo"] = "Повторить  Ctrl+Y",
            ...
            foreach (var entry in defaults)
            {
                if (existing.TryGetValue(entry.Key, out var existingValue))
                {
                    if ((legacyDefaults.TryGetValue(entry.Key, out var legacyValue)
                        ...
                        || IsKnownLegacyDefault(languageCode, entry.Key, existingValue))
                    {
    ...
    private static bool IsKnownLegacyDefault(string languageCode, string key, string value)
    {
        if (languageCode == RussianLanguageCode)
        {
            return (key == "Macros.Hint"
                    && value == "Записывает движение мыши, все её кнопки, прокрутку колеса, клавиатуру и сочетания клавиш. Нажмите F8 для остановки. Воспроизведение добавим следующим этапом.")
                || (key == "Macros.RecordingStarted"
                    && value == "Запись началась. Для остановки нажмите F8.")
        ...
        return (key == "Macros.Hint"
                && value == "Records mouse movement, all mouse buttons, wheel scrolling, keyboard input and key combinations. Press F8 to stop. Playback will be added in the next stage.")
            || (key == "Macros.RecordingStarted"
                && value == "Recording started. Press F8 to stop.")
            || (key == "Tooltips.MacroStop"
